...
user in an INI file next to MediaInfoPortable.exe called MediaInfoPortable.ini.
...
copy AppNamePortable.ini from this directory to MediaInfoPortable.ini next to
MediaInfoPortable.exe. The options in the INI file are as follows:
