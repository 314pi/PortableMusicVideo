...
user in an INI file next to VirtualDubPortable.exe called VirtualDubPortable.ini.
...
copy AppNamePortable.ini from this directory to VirtualDubPortable.ini next to
VirtualDubPortable.exe. The options in the INI file are as follows:
