...
user in an INI file next to WaveShopPortable.exe called WaveShopPortable.ini.
...
copy AppNamePortable.ini from this directory to WaveShopPortable.ini next to
WaveShopPortable.exe. The options in the INI file are as follows:
