...
user in an INI file next to AutoDrumPortable.exe called AutoDrumPortable.ini.
...
copy AppNamePortable.ini from this directory to AutoDrumPortable.ini next to
AutoDrumPortable.exe. The options in the INI file are as follows:
