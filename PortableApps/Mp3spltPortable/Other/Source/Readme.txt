...
user in an INI file next to Mp3spltPortable.exe called Mp3spltPortable.ini.
...
copy AppNamePortable.ini from this directory to Mp3spltPortable.ini next to
Mp3spltPortable.exe. The options in the INI file are as follows:
