...
user in an INI file next to DVDStylerPortable.exe called DVDStylerPortable.ini.
...
copy AppNamePortable.ini from this directory to DVDStylerPortable.ini next to
DVDStylerPortable.exe. The options in the INI file are as follows:
