DEVELOPER: Replace the three occurrences of VLCPortable in this file
...
user in an INI file next to VLCPortable.exe called VLCPortable.ini.
...
copy AppNamePortable.ini from this directory to VLCPortable.ini next to
VLCPortable.exe. The options in the INI file are as follows:
