...
user in an INI file next to LMMSPortable.exe called LMMSPortable.ini.
...
copy AppNamePortable.ini from this directory to LMMSPortable.ini next to
LMMSPortable.exe. The options in the INI file are as follows:
