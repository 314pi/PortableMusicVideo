...
user in an INI file next to AvidemuxPortable.exe called AvidemuxPortable.ini.
...
copy AppNamePortable.ini from this directory to AvidemuxPortable.ini next to
AvidemuxPortable.exe. The options in the INI file are as follows:
