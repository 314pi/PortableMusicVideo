...
user in an INI file next to MixxxPortable.exe called MixxxPortable.ini.
...
copy AppNamePortable.ini from this directory to MixxxPortable.ini next to
MixxxPortable.exe. The options in the INI file are as follows:
