...
user in an INI file next to AIMPPortable.exe called AIMPPortable.ini.
...
copy AppNamePortable.ini from this directory to AIMPPortable.ini next to
AIMPPortable.exe. The options in the INI file are as follows:
