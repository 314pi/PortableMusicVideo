...
user in an INI file next to CDExPortable.exe called CDExPortable.ini.
...
copy AppNamePortable.ini from this directory to CDExPortable.ini next to
CDExPortable.exe. The options in the INI file are as follows:
