...
user in an INI file next to CoolPlayer+Portable.exe called CoolPlayer+Portable.ini.
...
copy AppNamePortable.ini from this directory to CoolPlayer+Portable.ini next to
CoolPlayer+Portable.exe. The options in the INI file are as follows:
