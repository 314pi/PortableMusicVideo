...
user in an INI file next to TAudioConverterPortable.exe called TAudioConverterPortable.ini.
...
copy AppNamePortable.ini from this directory to TAudioConverterPortable.ini next to
TAudioConverterPortable.exe. The options in the INI file are as follows:
