DEVELOPER: Replace the three occurrences of InfraRecorderPortable in this file
...
user in an INI file next to InfraRecorderPortable.exe called InfraRecorderPortable.ini.
...
copy AppNamePortable.ini from this directory to InfraRecorderPortable.ini next to
InfraRecorderPortable.exe. The options in the INI file are as follows:
