...
user in an INI file next to TEncoderPortable.exe called TEncoderPortable.ini.
...
copy AppNamePortable.ini from this directory to TEncoderPortable.ini next to
TEncoderPortable.exe. The options in the INI file are as follows:
